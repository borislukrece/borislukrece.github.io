                                    ...
                                    ">
                                        ...
                                        ">
                                            <div style="
                                                ...
                                                display: flex;
                                            ">
                                                <a href="/?<?php if(isset($_GET['date']) && isset($_GET['date'])){ echo "&date=".valid_donnees($_GET['date']); } ?>" style="
                                                ...
                                                <a href="/?filter=month<?php if(isset($_GET['date']) && isset($_GET['date'])){ echo "&date=".valid_donnees($_GET['date']); } ?>" style="
                                                    padding: 0 1rem 0 1rem;
                                                    margin-right: 1rem;
                                                    border-radius: 1rem;
                                                    font-size: 0.8rem;
                                                ...
                                                <a href="/?filter=year<?php if(isset($_GET['date']) && isset($_GET['date'])){ echo "&date=".valid_donnees($_GET['date']); } ?>" style="
                                                    padding: 0 1rem 0 1rem;
                                                    margin-right: 1rem;
                                                    border-radius: 1rem;
                                                    font-size: 0.8rem;
                                                                ...
                                                                ">
                                                                    ...
                                                                    <?php
                                                                        ...
                                                                        if(intval(date("N", $dateVerifWeekend)) !== 7 && intval(date("N", $dateVerifWeekend)) !== 6){
                                                                            ...
                                                                            // echo "$SET_YEAR-$SET_MONTH-$SET_DAY";
                                                                        }else{
